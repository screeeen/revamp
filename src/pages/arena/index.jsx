  ...
  return (
    <Layout url={'https://vimeo.com/128135792'}>
      ...
      <RightMenu>
        ...
        <p>Arena Monster Alien Shooting Chaos challenges players to chase their highest score on short games of maximum 2 minutes period with an addictive loop between every game session.
